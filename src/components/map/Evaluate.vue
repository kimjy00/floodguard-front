<template>
  <div v v-if="this.$store.state.popupstore.EvaluatePopup" style="position: fixed; z-index: 5; width: 100%;">
    <div class="container" style="margin-top:1%; ">
      <div class="feedback">
        <div style="margin-top:50px;">
        <h1 style="text-align: center; font-size: large;">"Flood Guardian"에 대하여 얼마나 만족하십니까??</h1>
      </div>
        <div class="rating">
          <input type="radio" name="rating" v-model="rating" id="rating-5" value="5">
          <label for="rating-5"></label>
          <input type="radio" name="rating" v-model="rating" id="rating-4" value="4">
          <label for="rating-4"></label>
          <input type="radio" name="rating" v-model="rating" id="rating-3" value="3">
          <label for="rating-3"></label>
          <input type="radio" name="rating" v-model="rating" id="rating-2" value="2">
          <label for="rating-2"></label>
          <input type="radio" name="rating" v-model="rating" id="rating-1" value="1">
            ...
            <div class="emoji">
              <svg class="rating-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <ellipse transform="rotate(-148.804 180.87 175.82)" cx="180.871" cy="175.822" rx="28.048" ry="28.08"
                  fill="#3e4347" />
                <ellipse transform="rotate(-113.778 194.434 165.995)" cx="194.433" cy="165.993" rx="8.016" ry="5.296"
                  fill="#5a5f63" />
        ...
        <div>
          <a class="gradient-btn" href="#" @click="close">close</a>
          <a class="gradient-btn" href="#" @click="submit">submit</a>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    close() {
      this.$store.commit("popupstore/EvaluatePopupStateChange", false)
    },
    submit() {
      const param = {
        rating: this.rating
      }
      axios.post("/satisfactions/submit", param)
      .then((res) =>{
